...
<body>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="${pageContext.request.contextPath}/hairshop//hello">
                ...
                <div class="sidebar-brand-text mx-3">오늘 염색할까?! </div>
            </a>
            ...
            <!-- 고객관리 -->
             <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/customer/getCustomerList">
                    <i class="fas fa-fw fa-user"></i>
                    <span>고객관리</span></a>
            </li>
            <!-- 예약관리 -->
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/rsv/RsvList">
